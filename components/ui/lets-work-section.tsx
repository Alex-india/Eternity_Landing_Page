...
export function LetsWorkTogether({
  ...
  description = "Have a project in mind? We'd love to hear about it. Let's create something exceptional together.",
  email = "hello@eternity.dev",
  bookingUrl = "https://cal.com/jatin-yadav05/15min",
  callDurationText = "15 min intro call",
  ...
  return (
    <section className="flex min-h-screen items-center justify-center px-6 py-20" id="contact">
      <div className="relative flex flex-col items-center gap-12 max-w-4xl mx-auto w-full">
        <div
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            >
              ...
              <span className="block overflow-hidden pb-4">
                ...
                >
                  <span className="text-muted-foreground/60">{headingLine2}</span>
                </span>
              </span>
            </h2>
        ...
        >
          ...
          <a
            href={`mailto:${email}`}
            className="text-xs tracking-widest uppercase text-muted-foreground/60 hover:text-foreground transition-colors"
          >
            {email}
          </a>
        </div>
